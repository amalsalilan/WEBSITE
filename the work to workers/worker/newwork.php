...
<!---->
<?php
//$q="select * from event where status='pending' and workerid='$id'";
...
<!--	<td><a href="approved.php?id=--><?php //echo $row[0];?><!--">approve</a></td>-->
<!--	<td><a href="reject.php?id=--><?php //echo $row[0];?><!--">reject</a></td>-->
<!--	-->
<!--  </tr>-->
<!--  --><?php
//
