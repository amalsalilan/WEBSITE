<!--<form action="wrlogin.php" method="post" >-->
<!---->
<!--EMAIL<input type="email" required name="name" />-->
<!--<br>-->
<!--password<input type="password" required name="psw" />-->
<!--<br>-->
                            ...
                            <div id="site-navigation" class="site-navigation">
                                ...
                                <nav id="menu" class="menu">
                                    ...
                                    <li><a href="index.php">Home</a>
                                        ...
                                        <li><a href="#">USER</a>
                                            <ul>
                                                <li><a href="reg_fm.php">User Registration </a></li>
                                        ...
                                        <li><a href="#">Worker</a>
                                            <ul>
                                                <li><a href="workerfm.php">Worker Registration</a></li>
                                                <li><a href="workerlogin.php">Worker Login</a></li>
                ...
                <div class="col-md-12">
                    <div class="title-box ttm-textcolor-white">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <span><span>worker log in page</span></span>
                        </div>
                    </div>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-5 col-sm-12">
                        ...
                        <div class="ttm_single_image-wrapper text-left mb-35">
                            <img class="img-fluid" src="images/single-img-eleven.png" alt="">
                        </div>
                        ...
                        <div class="pl-5">
                            ...
                            <div class="section-title with-desc clearfix">
                                ...
                                <div class="title-header">
                                    <!--                                    <h5>WHY CHOOSE US</h5>-->
                                    <!--                                    <h2 class="title">Our Professional Maid services</h2>-->
                                </div>

                                <!--                                <div class="title-desc">We are a team of professional and skilled experts in all domestic spheres. We offer  range of service with any household needs:</div>-->
                            ...
                            <div class="row mb-40">
                                <div class="col-lg-6">
                                    ...
                                    <!--                                                <h5>Greate Technology</h5>-->
                                    <!--                                            </div>-->
                                    <!--                                        </div>-->
                                    <!--                                    </div>&lt;!&ndash; featured-icon-box end&ndash;&gt;-->
                                    featured-icon-box
                                    <!--                                    <div class="featured-icon-box left-icon">-->
...
<!--                                </div>-->
                                <div class="col-md-7">
                                    <!-- featured-icon-box -->
                                    <div class="featured-icon-box pt-15 pl-20">
                                        <div class="featured-content">
                                            <div class="featured-title">
<!--                                                <h5>Home Maintenace</h5>-->
                                            </div>
...
<!--                                                <a class="ttm-btn ttm-btn-size-sm ttm-icon-btn-right ttm-btn-color-skincolor btn-inline mt-10 mb-15" href="#">MORE ABOUT<i class="ti ti-angle-double-right"></i></a>-->
                                            </div>
                                        </div>
                                    </div><!-- featured-icon-box end-->
                                </div>
        ...
        <section class="ttm-row services2-section bg-img4 clearfix">
            <div class="container">
                ...
                <div class="row">
                    <div class="blog-slide owl-carousel owl-theme owl-loaded mt-10"  data-item="3" data-nav="false" data-dots="false" data-auto="true">
                        <!-- featured-imagebox -->
        ...
        <section class="ttm-row pricing-plan-section bg-img3 pb-180 res-991-pb-100 ttm-bgimage-yes ttm-bgcolor-white clearfix">
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="section-title style2 clearfix">
                            <div class="title-header">
                                <h5>PRICING & PLAN</h5>
                                <h2 class="title">A Monthly Fee Plan</h2>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-icon-btn-right ttm-btn-style-border ttm-btn-color-black mt-15 mb-30 float-right" href="#">Contact Us<i class="ti ti-angle-double-right"></i></a>
                    </div>
                </div><!-- row end -->
                <div class="row m-0 pt-65 pl-15 pr-15 res-767-pt-15">
                    <div class="col-md-4">
                        ...
                        <div class="ttm-pricing-plan clearfix">
                            <div class="ttm-ptablebox-title"><h3>Professional</h3></div>
                            ...
                            <div class="ttm-ptablebox-price-w">
                                ...
                                <div class="ttm-ptablebox-price">70.00</div>
                            ...
                            <div class="ttm-ptablebox-content">
                                <div class="ttm-ptablebox-features">
                                    <ul class="ttm-feature-lines">
                                        ...
                                        <li>3 GB Storage</li>
                                        <li>16GB Bnadwidth</li>
                                    </ul>
                                </div>
                                <div class="price_btn">
                                    <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-bgcolor-grey ttm-btn-color-black" href="#">Order Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <!--ttm-pricing-plan-->
                        <div class="ttm-pricing-plan ttm-ptablebox-featured-col clearfix">
                            <div class="ttm-featured-title"><i class="fa fa-star"></i>MOST POPULAR</div>
                            <div class="ttm-ptablebox-title"><h3>Standard</h3></div>
                            <div class="ttm-ptablebox-desc">Designed for businesses with standard health requirements</div>
                            <div class="ttm-ptablebox-price-w">
                                <div class="ttm-ptablebox-cur-symbol-before">$</div>
                                <div class="ttm-ptablebox-price">50.00</div>
                                <div class="ttm-ptablebox-frequency">per month</div>
                            </div>
                            <div class="ttm-ptablebox-content">
                                <div class="ttm-ptablebox-features">
                                ...
                                <div class="price_btn">
                                    <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-bgcolor-skincolor ttm-btn-color-white" href="#">Order Now</a>
                                </div>
                            </div>
                        </div><!--ttm-pricing-plan-->
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="ttm-pricing-plan clearfix">
                            ...
                            <div class="ttm-ptablebox-price-w">
                                <div class="ttm-ptablebox-cur-symbol-before">$</div>
                                <div class="ttm-ptablebox-price">80.00</div>
                                <div class="ttm-ptablebox-frequency">per month</div>
                            </div>
                            <div class="ttm-ptablebox-content">
                                <div class="ttm-ptablebox-features">
