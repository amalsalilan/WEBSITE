...
<!--}-->
<!--</script>-->
<!--<form action="wkr.php" method="post" enctype="multipart/form-data" >-->
<!---->
...
//	   $q="select distinct state from district_tb";
...
<!--<br>-->
<!--mobile<input type="number" name="mobile" value="number"/>-->
<!--<br>-->
...
<!--	   -->
<!--<br />-->
<!--experience <input type="text" name="experience" value=""  />-->
<!--<br />-->
<!--id proof <input type="file" name="id_proof" value=""  />-->
<!--<br />-->
...
<!---->
<!--name <input type="text" required pattern="[a-zA-Z\s]{2,20}" title="Only char allowed" name="name" />-->
<!--<br>-->
...
<!--       f <input type="radio" name="gender" value="female" />-->
<!--	   <br>-->
<!--place  <input type="text" name="place"required pattern="[a-zA-Z\s]{2,50}" title="Only char allowed" />-->
<!--<br>-->
<!--address <textarea name="address" required pattern="[a-zA-Z\s]{2,100}" title="Only char allowed"> </textarea>-->
<!--<br>-->
<!--email<input type="email" name="email" value="email"/>-->
<!--<br>-->
<!--password<input type="password" required pattern=".{8,}" title="Min 8 char" name="password" value=""/>-->
<!--<br>-->
<!--mobile<input type="number" name="mobile" required pattern="[0-9]{10}" value="number"/>-->
<!--<br>-->
<!--<input type="submit" value="Register" />-->
<!---->
<!--</form>-->
                ...
                <div class="col-md-12">
                    <div class="title-box ttm-textcolor-white">
                        <div class="page-title-heading">
                            <h1 class="title">Worker Registration</h1>
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <span><span>Worker Registration page</span></span>
                        </div>
                    </div>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
                                ...
                                <div class="col-md-4">
                                    <div class="ttm-pf-single-detail-box res-991-mt-30">
                                        <div class="ttm-portfolio-title">
                                            <h2 class="ttm-pf-detailbox-title">Worker REGISTRATION</h2>
                                        </div>
                                        <div class="ttm-pf-detailbox">
                                            <ul class="ttm-pf-detailbox-list">
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <!--                                                    <span class="ttm-pf-right-details">Roof Ceiling</span>-->
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                ...
                                                <!--                                                    <span class="ttm-pf-right-details">Carpenting</span>-->
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                ...
                                                <!--                                                    <span class="ttm-pf-right-details">6 Days</span>-->
                                                </li>
                                                <!--                                                <li class="ttm-pf-details-date">-->
        ...
        <section class="ttm-row bg-layer pt-0 pb-0 ttm-textcolor-white mt_175 res-991-mt-0 res-991-pt-0 clearfix">
            <div class="container">
                <div class="row row-equal-height">
                    ...
                    <div class="col-lg-6">
                        <div class=" ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-skincolor spacing-8">
                            <div class="ttm-col-wrapper-bg-layer ttm-bg-layer"></div>
                            <div class="layer-content">
                                <div class="single-image">
                                    <img class="img-fluid mt_70 res-991-mt-0" src="images/single-img-six.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="ttm-box-view-content-inner">
                                ...
                                <div class="ttm-box-view-overlay">
                                    <div class="featured-iconbox ttm-media-link">
                                        <a class="ttm_prettyphoto ttm_image" title="Plumbing, New York" data-rel="prettyPhoto" href="images/portfolio/01.jpg"><i class="ti ti-search"></i></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio ttm-box-view-top-image">
                            <div class="ttm-box-view-content-inner">
                                ...
                                <div class="ttm-box-view-overlay">
                                    <div class="featured-iconbox ttm-media-link">
                                        <a class="ttm_prettyphoto ttm_image" title="Home Maintenance" data-rel="prettyPhoto" href="images/portfolio/02.jpg"><i class="ti ti-search"></i></a>
                                        <a href="portfolio-style-1.html" class="ttm_link"><i class="ti ti-link"></i></a>
                                    </div>
                                </div><!-- ttm-box-view-overlay end-->
                            </div>
