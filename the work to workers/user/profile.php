                            ...
                            <div class="col-lg-6">
                                <div class="billing-fields">
                                    ...
                                    <form action="editprofile.php" method="post">
                                        name<input type="text"required pattern="[a-zA-Z\s]{2,20}" name="name" value="<?php echo $row[1];?>"><br />
                                        ...
                                        address<input  type="text"required pattern="[a-zA-Z\s]{2,100}"name="address"value="<?php echo $row[5];?>" /> <br />
