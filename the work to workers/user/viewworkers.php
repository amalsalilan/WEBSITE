<!--<script>-->
<!--function searchbyskill(skill,dist)-->
<!--{-->
...
<!--}-->
<!--obj.open("GET","searchbyskill.php?skill="+skill+"&dist="+dist,true);-->
<!--obj.send();-->
...
<!--document.getElementById("workerslist").innerHTML=res;-->
<!--}-->
<!--}-->
<!---->
<!--}-->
...
<!---->
<!--choose skill-->
<!--<select name="skill" id="skill" onChange="searchbyskill(this.value,district.value)">-->
...
<!---->
<!--	   choose location-->
<!--<select name="state" onChange="selectDistrict(this.value)">-->
<!--       <option value=""> select </option>-->
<!--	   --><?php
//	   $conn=mysqli_connect("localhost","root","","work2work");
...
<!---->
<!--	   choose district-->
<!--<select name="district" id="district" onChange="searchbyskill(skill.value,this.value)">-->
<!--       <option value=""> select </option>-->
<!---->
<!--	   </select>-->
<!---->
...
//?>
<!-- <tr>-->
<!--    <td><a href="feedback.php?wid=--><?php //echo $row[0];?><!--">--><?php //echo $row[1]; ?><!--</a></td>-->
...
//?>
<!---->
<!--	<td><a href="workform.php?wid=--><?php //echo $row[0];?><!--">select</a></td>-->
<!---->
<!---->
<!---->
<!--  </tr>-->
                ...
                <div class="col-md-12">
                    <div class="title-box ttm-textcolor-white">
                        <div class="page-title-heading">
                            <h1 class="title">View Workers</h1>
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <span><span>view workers</span></span>
                        </div>
                    </div>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
