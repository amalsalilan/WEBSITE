...
<?php
//
//$q="select * from event,worker where event.workerid=worker.id and event.userid='$id' ";
                ...
                <div class="col-md-12">
                    <div class="title-box ttm-textcolor-white">
                        <div class="page-title-heading">
                            <h1 class="title">View approved Workers</h1>
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <span><span>view approved  workers</span></span>
                        </div>
                    </div>
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
